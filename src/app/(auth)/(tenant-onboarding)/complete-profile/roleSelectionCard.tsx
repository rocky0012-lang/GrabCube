...
const RoleSelectionCard = ({ title, description, href, buttonText, icon: Icon }: RoleSelectionCardProps) => {
  return (
        <Card className="mx-auto rounded-2xl w-3/4 hover:-translate-y-1 hover:border-[var(--color-accent-gold)]">
          <CardHeader>
            <Icon aria-hidden="true" className="size-6 text-[var(--color-accent-gold)]" />
